<template>
    <div class="flex flex-col gap-[20px] p-[20px] w-full min-h-screen border border-red-800">
...
import Box_V2 from '@/components/Dashboard/Box/Box_V2.vue';
import Button from '@/components/Dashboard/Button/Button.vue';
import ProductSingle from '@/components/Dashboard/Product/ProductSingle.vue';
